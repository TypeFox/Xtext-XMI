/**
 */
package io.typefox.xtextxmi.tree.provider;
...
/**
 * This is the item provider adapter for a {@link io.typefox.xtextxmi.tree.Node} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addRelatedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Node_related_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Node_related_feature", "_UI_Node_type"),
				 TreePackage.Literals.NODE__RELATED,
				 true,
				 false,
				 true,
				 null,
